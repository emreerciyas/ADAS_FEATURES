# 1 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
# 1 "C:\\Evidence\\workspace\\Full_Project\\erika//"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
# 54 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
...
# 55 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c" 2
...
# 133 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
  if (p_curr_tcb->current_prio < p_tcb_act->current_prio) {
    OsEE_SN * const
      p_new_stk = osEE_sn_alloc(&p_ccb->p_free_sn);
# 149 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
...
)
{
  ...
  (void)p_kdb;
  osEE_lock_core(p_cdb);
# 213 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
  {
...
)
{
  ...
  osEE_unlock_core(p_cdb);
# 301 "C:\\Evidence\\WORKSP~1\\FULL_P~1\\erika\\src\\ee_oo_sched_partitioned.c"
  return is_preemption;
}
